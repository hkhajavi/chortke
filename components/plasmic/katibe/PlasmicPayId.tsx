...
import sty from "./PlasmicPayId.module.css"; // plasmic-import: fXYKZYfose53/css
...
export type PlasmicPayId__VariantMembers = {};
export type PlasmicPayId__VariantsArgs = {};
type VariantPropType = keyof PlasmicPayId__VariantsArgs;
export const PlasmicPayId__VariantProps = new Array<VariantPropType>();

export type PlasmicPayId__ArgsType = {};
type ArgPropType = keyof PlasmicPayId__ArgsType;
export const PlasmicPayId__ArgProps = new Array<ArgPropType>();

export type PlasmicPayId__OverridesType = {
  pay?: Flex__<"div">;
...
export interface DefaultPayIdProps {}
...
function PlasmicPayId__RenderFunc(props: {
  variants: PlasmicPayId__VariantsArgs;
  args: PlasmicPayId__ArgsType;
  overrides: PlasmicPayId__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicPayId.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicPayId.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicPayId__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicPayId__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicPayId__ArgProps,
          internalVariantPropNames: PlasmicPayId__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicPayId__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "pay") {
    func.displayName = "PlasmicPayId";
  } else {
    func.displayName = `PlasmicPayId.${nodeName}`;
  }
  return func;
}

export const PlasmicPayId = Object.assign(
  // Top-level PlasmicPayId renders the root element
  makeNodeComponent("pay"),
  {
    ...
    // Metadata about props expected for PlasmicPayId
    internalVariantProps: PlasmicPayId__VariantProps,
    internalArgProps: PlasmicPayId__ArgProps,
