...
import Button from "../../Button"; // plasmic-import: oMlyAE-sgBTl/component
...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: 3p5lHK1MOgje/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: VZ6Vl-sB0jLM/icon
import Icon20Icon from "./icons/PlasmicIcon__Icon20"; // plasmic-import: hs1r53dOSjtc/icon
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__lDvR)}
                >
                  {"Show dialog"}
                </Button>
              ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__q8Sqc)}
              >
                <div
                  className={classNames(
                    projectcss.all,
