...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: nwT0EaGINwPy/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 7wkEfmUYAcMf/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__bQ9)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__siX8)}
              />
            </React.Fragment>
          ),
          value: args.children
