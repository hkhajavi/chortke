...
import Icon21Icon from "./icons/PlasmicIcon__Icon21"; // plasmic-import: 5cMRv2c3LIXT/icon
    ...
    <button
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootoutline_color_red]:
            hasVariant($state, "outline", "outline") &&
            hasVariant($state, "color", "red"),
          [sty.rootoutline_color_red____focusVisibleWithin]:
            hasVariant($state, "color", "red") &&
            hasVariant($state, "outline", "outline") &&
            triggers.focusVisibleWithin_root,
          ...
          [sty.rootsize_compact_color_text]:
            hasVariant($state, "color", "text") &&
            hasVariant($state, "size", "compact"),
          [sty.rootsize_compact_color_text_showStartIcon]:
            hasVariant($state, "color", "text") &&
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "showStartIcon", "showStartIcon"),
      ...
      {(
        ...
        <div
          ...
          className={classNames(projectcss.all, sty.contentContainer, {
            ...
            [sty.contentContaineroutline_color_red_loading]:
              hasVariant($state, "loading", "loading") &&
              hasVariant($state, "color", "red") &&
              hasVariant($state, "outline", "outline"),
          ...
          <Icon21Icon
            ...
            className={classNames(projectcss.all, sty.svg, "loader", {
              ...
              [sty.svgloading_color_link]:
                hasVariant($state, "loading", "loading") &&
                hasVariant($state, "color", "link"),
              [sty.svgoutline_color_red_loading]:
                hasVariant($state, "loading", "loading") &&
                hasVariant($state, "color", "red") &&
                hasVariant($state, "outline", "outline"),
          ...
          {(hasVariant($state, "loading", "loading") ? false : true)
            ? renderPlasmicSlot({
                ...
                className: classNames(sty.slotTargetChildren2, {
                  ...
                  [sty.slotTargetChildren2outline_color_red]:
                    hasVariant($state, "color", "red") &&
                    hasVariant($state, "outline", "outline"),
                  [sty.slotTargetChildren2outline_color_red_loading]:
                    hasVariant($state, "loading", "loading") &&
                    hasVariant($state, "color", "red") &&
                    hasVariant($state, "outline", "outline"),
                  [sty.slotTargetChildren2outline_color_red_shape_rounded]:
                    hasVariant($state, "outline", "outline") &&
                    hasVariant($state, "color", "red") &&
                    hasVariant($state, "shape", "rounded"),
