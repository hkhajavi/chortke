...
import sty from "./PlasmicButton.module.css"; // plasmic-import: oMlyAE-sgBTl/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__bZuY4)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon20Icon
                className={classNames(projectcss.all, sty.svg__tui9R)}
                role={"img"}
              />
            ),
